<template>
  <div>
    ...
    <div style="padding: 5px 0 0 0;text-align: right;display: flex;flex-direction: row;">
      <el-input style="width: 200px"  placeholder="请输入要查询的用户名" suffix-icon="el-icon-user" v-model="uname"></el-input>
    ...
    <div style="text-align: right;width: 100%;position: relative">
      ...
      >
      <el-button type="primary" style="margin:5px 10px 5px 0;">上传 <i class="el-icon-top"></i></el-button>
      </el-upload>
      <el-button type="primary" style="margin:5px 0 5px 0;" @click="exp">下载 <i class="el-icon-bottom"></i></el-button>
    </div>
