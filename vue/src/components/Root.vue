<template>
  <div>
    <div style="padding: 5px 0 0 0;text-align: right;display: flex;flex-direction: row;">
      <el-input style="width: 200px"  placeholder="请输入要查询的管理员名" suffix-icon="el-icon-user" v-model="uname"></el-input>
      <el-input style="width: 200px"  placeholder="请输入要查询的管理员昵称" suffix-icon="el-icon-star-off" v-model="unickname"></el-input>
    ...
    <div style="height: 400px;max-width: 1800px">
      <el-table header-row-class-name="headerbg" max-height="450" v-loading="loading"
        ...
        <el-table-column prop="uname" label="管理员名" width="100">
        </el-table-column>
    ...
    <el-dialog title="管理员信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small" :model="form">
        ...
        <el-form-item label="身份">
          <el-input v-model="form.status" placeholder="请输入3" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods:{
    load() {
      this.loading = true
      this.request.get("/user/rootPage", {
        params: {
